...
class DoublyLinkedList:
    ...
    def print_backward(self):
        ...
        if self.head is None:
            ...
            print(f'List has only one element: {self.head.data}')
            return
...
if __name__ == '__main__':
    ...
    ll.print_forward()
    ll.insert_after_value('orange', 'new value')
    ll.print_forward()
    print(ll.get_len())
    ll.print_forward()
    print(ll.get_last_node())
    ll.insert_at_begining('Inserted at begining')
    ll.insert_at_end('Inserted at end')
    ll.print_forward()
    ll.print_backward()
